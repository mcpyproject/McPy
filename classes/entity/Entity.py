...
class Entity:
    ...
    def __init__(self, entity_id, entity_location: Vector3, world, x_rot=0, y_rot=0, nbt_tags: dict = {}):
...
class EntityManager():
    ...
    def make_entity(self, entity_class: Entity, entity_location: Vector3, world, **kwargs):
